...
public class Allowance_approval extends AppCompatActivity {
    ...
    String json_url2 = Url_interface.url+"Allowance/Allowance_Approval.php";
    String json_string2="";
    ...
    public class backgroundworker2 extends AsyncTask<Void,Void,String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            try {
                ...
                OutputStream outputStream = httpURLConnection.getOutputStream();
                BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(outputStream, "UTF-8"));
                String post_data = URLEncoder.encode("allowance_status","UTF-8")+"="+URLEncoder.encode(allowance_status,"UTF-8")+"&"
                        +URLEncoder.encode("allowance_id","UTF-8")+"="+ URLEncoder.encode(sallowance_id,"UTF-8");
                bufferedWriter.write(post_data);
                Log.d("PostData",""+post_data);
                bufferedWriter.flush();
                bufferedWriter.close();
        ...
        protected void onPostExecute(String result) {
            ...
            try{
                if(json_string2.equals("NO")){
                    Toast.makeText(Allowance_approval.this, "Contact Admin", Toast.LENGTH_SHORT).show();
                }else{
                    progressDialog.show();
                    new backgroundworker().execute();
                    LallowanceId.clear();
    ...
    public class CustomAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            view = getLayoutInflater().inflate(R.layout.custom_layout_allowance_approval, null);
    ...
    public void intialise(){
        progressDialog = new ProgressDialog(Allowance_approval.this);
        progressDialog.setMessage("Please Wait...!!!");
        progressDialog.setCanceledOnTouchOutside(false);
        sessionMaintance = new SessionMaintance(Allowance_approval.this);
