...
public class Allowance_history extends AppCompatActivity {

    ListView listView;
    ProgressDialog progressDialog;
    SessionMaintance sessionMaintance;
    StringBuffer sb = new StringBuffer();
    String json_url = Url_interface.url+"Allowance/Allowance_History.php";
    String json_string="";
    ...
    List<String> LallowanceDate = new ArrayList<>();
    List<String> LallowanceTime = new ArrayList<>();
    List<String> LallowanceRupees = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_allowance_history);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.allowance_history), (v, insets) -> {
    ...
    public class backgroundworker extends AsyncTask<Void,Void,String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            try {
                ...
                LallowanceDate.clear();
                LallowanceTime.clear();
        ...
        protected void onPostExecute(String result) {
            ...
            try{
                ...
                while(count<jsonArray.length()){
                    ...
                    LallowanceType.add(jsonObject1.getString("allowance_type"));
                    LallowanceRupees.add(jsonObject1.getString("allowance_amount"));
                    LallowanceRemarks.add(jsonObject1.getString("remarks"));
                    LallowancePhotos.add(jsonObject1.getString("photos"));
                    LallowanceDate.add(jsonObject1.getString("date"));
                    LallowanceTime.add(jsonObject1.getString("time"));
    ...
    public class CustomAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            ImageView allowance_reject_or_app = view.findViewById(R.id.imageView4);
            ...
            TextView allowancer_date = view.findViewById(R.id.textView21);
            TextView allowancer_time = view.findViewById(R.id.textView22);
            TextView allowancer_rupees = view.findViewById(R.id.textView23);
            ...
            allowancer_date.setText(LallowanceDate.get(i));
            allowancer_time.setText(LallowanceTime.get(i));
            allowancer_rupees.setText(LallowanceRupees.get(i));
    ...
    private void showImagesOneByOne() {
        if (currentIndex < urlArray.length) {
            ImageView imageView = new ImageView(Allowance_history.this);
            imageView.setAdjustViewBounds(true);
            Picasso.get().load(Url_interface.url+"Allowance/"+urlArray[currentIndex]).into(imageView);
            AlertDialog.Builder builder = new AlertDialog.Builder(Allowance_history.this);
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Toast.makeText(Allowance_history.this, "", Toast.LENGTH_SHORT).show();
    ...
    public void intialise(){
        progressDialog = new ProgressDialog(Allowance_history.this);
        progressDialog.setMessage("Please Wait...!!!");
        progressDialog.setCanceledOnTouchOutside(false);
        sessionMaintance = new SessionMaintance(Allowance_history.this);
